...
![analisis](assets/chapter02/ana2.png)
...
| EP02/US05 | Consulta de progreso en el tablero personalizado | Como usuario, quiero consultar mi progreso hacia mis objetivos de salud y fitness en un tablero personalizado con interfaz atractiva. | Given que el usuario ha ingresado a su cuenta,<br><br>When el usuario accede al tablero de progreso,<br><br>Then el usuario puede ver gráficos y estadísticas detalladas de su progreso en términos de pérdida de peso, ganancia muscular, etc. | EP02 |
