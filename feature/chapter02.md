...
![analisis](assets/chapter02/ana.png)
...
| EP02/US05 | Consulta de progreso en el tablero personalizado | Como usuario, quiero consultar mi progreso hacia mis objetivos de salud y fitness en un tablero personalizado. | Given que el usuario ha ingresado a su cuenta,<br><br>When el usuario accede al tablero de progreso,<br><br>Then el usuario puede ver gráficos y estadísticas detalladas de su progreso en términos de pérdida de peso, ganancia muscular, etc. | EP02 |
| EP02/US06 | Exploración de programas de entrenamiento específicos | Como usuario, quiero explorar una variedad de programas de entrenamiento específicos adaptados a mis necesidades y preferencias. | Given que el usuario ha navegado a la sección de programas de entrenamiento,<br><br>When el usuario filtra los programas por tipo, duración, nivel de dificultad, etc.,<br><br>Then el usuario puede explorar y seleccionar programas de entrenamiento específicos según sus preferencias. | EP02 |
| EP02/US07 | Solicitud de seguimiento y retroalimentación personalizada | Como usuario, quiero solicitar seguimiento y retroalimentación personalizada de profesionales de la salud y entrenadores. | Given que el usuario ha completado una sesión de ejercicio o actividad física,<br><br>When el usuario solicita retroalimentación en la aplicación,<br><br>Then el usuario recibe seguimiento y retroalimentación personalizada de un entrenador o profesional de fitness. | EP02 |
| EP02/US08 | Programación de recordatorios y alarmas | Como usuario, quiero poder programar recordatorios y alarmas para mis actividades diarias de salud y fitness. | Given que el usuario ha seleccionado una actividad o evento en la aplicación,<br><br>When el usuario programa un recordatorio o alarma para esa actividad,<br><br>Then el usuario recibe notificaciones y recordatorios en la aplicación en los momentos programados. | EP02 |
...
| EP02/US09 | Recepción de notificaciones sobre nuevos programas | Como usuario, quiero recibir notificaciones y actualizaciones sobre nuevos programas de entrenamiento y consejos de salud. | Given que el usuario ha habilitado las notificaciones en la aplicación,<br><br>When se lanzan nuevos programas de entrenamiento o actualizaciones,<br><br>Then el usuario recibe notificaciones sobre los nuevos programas disponibles. | EP02 |
| EP04/US02 | Compartir progreso y logros en redes sociales | Como usuario, quiero poder compartir mi progreso y logros en las redes sociales para inspirar a otros y recibir apoyo de la comunidad. | Given que el usuario ha alcanzado un hito o logro importante en su progreso,<br><br>When el usuario selecciona la opción de compartir en redes sociales,<br><br>Then el usuario puede compartir su progreso y logros en plataformas de redes sociales como Facebook, Twitter, etc. | EP04 |
...
|-------|---------------|--------|-------------|--------------|
| 1     | EP01/US01     | Creación de cuenta de usuario | Como usuario, deseo poder crear una cuenta para acceder a todas las funcionalidades de la aplicación. | 3 |
| 2     | EP02/US02     | Establecimiento de objetivos de salud y fitness | Como usuario, deseo establecer mis objetivos de salud y fitness al registrarme en la aplicación. | 5 |
| 3     | EP02/US03     | Recibir recomendaciones personalizadas sobre dieta y ejercicio | Como usuario, deseo recibir recomendaciones personalizadas sobre dieta y ejercicio basadas en mis objetivos y preferencias. | 8 |
| 4     | EP03/US01     | Registro y seguimiento de la ingesta diaria de alimentos y calorías | Como usuario, deseo poder registrar y realizar un seguimiento de mi ingesta diaria de alimentos y calorías. | 3 |
| 5     | EP02/US04     | Registro y seguimiento de actividades físicas y ejercicios | Como usuario, deseo poder registrar y hacer un seguimiento de todas mis actividades físicas y ejercicios realizados. | 5 |
| 6     | EP02/US05     | Consulta de progreso en el tablero personalizado | Como usuario, deseo consultar mi progreso hacia mis objetivos de salud y fitness en un tablero personalizado. | 3 |
| 7     | EP02/US06     | Exploración de programas de entrenamiento específicos | Como usuario, deseo explorar una variedad de programas de entrenamiento específicos adaptados a mis necesidades y preferencias. | 5 |
| 8     | EP02/US07     | Solicitud de seguimiento y retroalimentación personalizada | Como usuario, deseo solicitar seguimiento y retroalimentación personalizada de profesionales de la salud y entrenadores. | 8 |
| 9     | EP02/US08     | Programación de recordatorios y alarmas | Como usuario, deseo poder programar recordatorios y alarmas para mis actividades diarias de salud y fitness. | 3 |
| 10    | EP04/US01     | Interacción en la comunidad de la aplicación | Como usuario, deseo interactuar con otros usuarios en una comunidad dentro de la aplicación para compartir experiencias y motivación. | 5 |
| 11    | EP05/US01     | Acceso a contenido exclusivo y características premium | Como usuario, deseo acceder a contenido exclusivo y características premium mediante una suscripción mensual o anual. | 8 |
| 12    | EP02/US09     | Recepción de notificaciones sobre nuevos programas | Como usuario, deseo recibir notificaciones y actualizaciones sobre nuevos programas de entrenamiento y consejos de salud. | 3 |
| 13    | EP04/US02     | Compartir progreso y logros en redes sociales | Como usuario, deseo poder compartir mi progreso y logros en las redes sociales para inspirar a otros y recibir apoyo de la comunidad. | 5 |
| 14    | EP06/US01     | Acceso a herramientas de análisis de datos | Como usuario, deseo acceder a herramientas de análisis y visualización de datos para comprender mejor mi progreso y áreas de mejora. | 8 |
| 15    | EP04/US03     | Participación en desafíos y competiciones | Como usuario, deseo participar en desafíos y competiciones dentro de la comunidad para mantenerme motivado y comprometido. | 5 |
