...
| ![Angel](assets/chapter01/image.png)                | Mi nombre es Angel Cancho Corilla con el código de estudiante u201721995, estudio la carrera de Ingeniería de Software. Tengo conocimientos en C# y Angular, las cuales aportaran a la elaboración del proyecto final. Me caracterizo por mi dedicación para completar todas las labores asignadas. Además, cuento con la habilidad de liderazgo necesaria para guiar al equipo hacia la presentación de un proyecto de alta calidad.|
| ![Diego](assets/chapter01/Diego.png)                | Mi nombre es Diego Pumahualcca y tengo 19 años. Estoy cursando la carrera de Ingeniería de Software en la UPC. Elegi la carrera, porque me interese por la creacion de paginas web y el diseño web. Con el paso del tiempo me gusto hacer los diagramas de clases, contexto, contenedores, componentes, etc. |
| ![Brenda](assets/chapter01/Brenda-photo.jpg)        | Soy Brenda Gamio Upiachihu de código u202120344 en la carrera de Ingeniería de Software. Tengo conociminetos en C++, Python, HTML, CSS y JavaScript, además de un conocimiento básico en base datos SQL y No SQL. Soy alguien autodidacta que le gusta aprender e investigar, lo cual ayuda a facilitar el trabajo en equipo que haremos. |
...
| Especialista en nutrición: Médico que aconseja a cerca de las preocupaciones de salud específicas, como control de peso, enfermedades o condiciones médicas que tiene el usuario.                 |              Edad: Desde jóvenes adultos hasta personas mayores.<br/> Género: Varía (Hombre y Mujer).<br/> Nivel de Educación: Educación avanzada en medicina y nutrición.<br/> Ubicación Geográfica: Urbanos y suburbanos en áreas donde el acceso a instalaciones de fitness y alimentos saludables es más común.               |                                                                                                                                             Cito, “demandan una atención integral y a largo plazo, teniendo en cuenta que la posibilidad de recaídas forma parte del proceso de recuperación.” (Ángel Esteban Torres Zapata, ___Perspectivas Actuales en Nutrición___) |
